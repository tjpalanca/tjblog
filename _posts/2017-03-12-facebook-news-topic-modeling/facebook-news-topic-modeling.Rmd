...
```{r setup}
library(magrittr)
htmltools::includeScript("../../static/custom/iframes.js")
```
...
```{r layout="l-body-outset", fig.cap="TOPIC MODELING - A brief overview of how topic modeling is performed."}
...
```{r layout="l-page", fig.cap="Sample articles from the LDA classification (click to zoom)"}
...
```{r layout="l-body-outset", fig.cap = "TOPIC TRENDS - Hover over each square to view sample articles. Red dots indicates 'peaks' for each topic", out.extra="onload='resizeIframe(this)'"}
...
```{r layout="l-body-outset", fig.cap = "TOPIC TRENDS - Hover over each line to view the line in relation to others and to display the topic name as a tooltip", out.extra="onload='resizeIframe(this)'"}
...
```{r layout="l-body-outset", fig.cap="BIAS AND BALANCE - Check the news distribution and hover over each bar for details.", out.extra="onload='resizeIframe(this)'"}
...
```{r layout="l-body-outset", fig.cap="TOPIC CONCENTRATION - Hover over each bar to see the top topics for that page.", out.extra="onload='resizeIframe(this)'"}
