...
```{r layout="l-page", fig.cap="News Landscape of the Philippines ([zoom](figures/news-landscape-map.png))"}
...
```{r layout="l-screen", fig.cap="Sample articles from the LDA classification ([zoom](figures/topic-classification-sample.png))"}
...
```{r layout="l-body-outset", fig.cap = "TOPIC TRENDS - Hover over each square to view sample articles. Red dots indicates 'peaks' for each topic"}
...
```{r layout="l-body-outset", fig.cap = "TOPIC TRENDS - Hover over each line to view the line in relation to others and to display the topic name as a tooltip"}
...
```{r layout="l-body-outset", fig.cap="BIAS AND BALANCE - Check the news distribution and hover over each bar for details."}
...
```{r layout="l-body-outset", fig.cap="TOPIC CONCENTRATION - Hover over each bar to see the top topics for that page."}
