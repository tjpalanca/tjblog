...
In these cases, the best course of action is to invest time in parameterizing these decisions. We can set them at the value that makes sense for now, but build into the product functionality to quickly switch this parameter once we have new information (and to replace this with some machine learned decision once we have enough examples). 

This way, the product development can move forward without having to make potentially costly decisions that are hard to reverse down the line.

Put another way: you can either build perfect prediciton such that you know exactly what will happen as you roll out your data product, or you can build in split second reaction times such that you'll never really need the foreecast.
