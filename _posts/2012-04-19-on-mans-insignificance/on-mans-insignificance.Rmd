...
```{r fig.cap="Yup, that's the earth from 4 billion miles away."}
knitr::include_graphics("images/pale-blue-dot.jpeg")
```
...
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/wupToqz1e2g" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
